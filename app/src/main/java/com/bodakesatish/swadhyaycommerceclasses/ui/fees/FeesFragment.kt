package com.bodakesatish.swadhyaycommerceclasses.ui.fees
...
import com.bodakesatish.swadhyaycommerceclasses.databinding.FragmentFeesBinding
...
class FeesFragment : Fragment() {
    ...
    private var binding: FragmentFeesBinding? = null
